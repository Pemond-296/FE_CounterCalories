    ...
    <>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.BMR}>Chỉ số trao đổi chất (BMR)</Text>
          <View style={styles.action}>
            <Text style={styles.text6}>Bạn vận động như thế nào?</Text>
            <View style={styles.field}>
              ...
              />
              <Text style={styles.text5}>Phút</Text>
            </View>
            {errors.minute && (
              <Text style={styles.error}>{errors.minute.message}</Text>
            )}
            <View style={styles.field}>
              <TextInput
                ...
                onBlur={() => setIsFocused(0)}
              />
              <Text style={styles.text5}>Ngày</Text>
            </View>
            {errors.day && (
              <Text style={styles.error}>{errors.day.message}</Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.in4}>
          <View style={styles.gender}>
            <View
              ...
              <Icon
                ...
                size={100}
              />
              <Text style={[styles.box.text, isMale && styles.text4]}>Nam</Text>
            </View>
            <View
              style={[styles.box, !isMale && styles.isMale]}
              onTouchEndCapture={() => {
              ...
              <Icon
                ...
                size={100}
              />
              <Text style={[styles.box.text, !isMale && styles.text4]}>Nữ</Text>
            </View>
          </View>

          <View style={styles.height}>
            <Text style={styles.text1}>Chiều cao (cm)</Text>
          ...
          <View style={styles.weight}>
            <View style={styles.age}>
              <Text style={styles.head}>Cân nặng (kg)</Text>
              <Text style={styles.age.body}>{weight}</Text>
            ...
            <View style={styles.age}>
              <Text style={styles.head}>Tuổi</Text>
              <Text style={styles.age.body}>{age}</Text>
              <View style={styles.act}>
                <Icon1
                  style={styles.icon2}
                  size={25}
